...
|---|---|---|
| A1 | evidence-backed | Retroactively verified against the shipped result: `test/fixtures/setup-complete/{domain-valid,domain-empty}.yaml` are two 10-line targeted YAML fixtures, not a full synthetic consumer-repo tree — matches the claim exactly. |
