...
|---|---|---|---|---|---|
| requirement, generated-output, source-of-truth, release, maintainability | cap of 2 reviewers over ten categories | five areas went unread, and the security posture of the generated-output path was not re-read either | workflow owner | no | R1 |
