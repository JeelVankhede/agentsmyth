...
- **Q5** (bucket R1) — recommend deferring; rests on F2 (web), which is the only class that could settle an upstream-spec question
...
|---|---|---|
| R1 | what the upstream spec says | web |
