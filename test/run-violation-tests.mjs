...
const fixtures = [
  ...
  { id: 'ep', dir: 'test/fixtures/lifecycle-violations/ep-citation-range-past-eof', description: '(WP-R21, R10) cited line range runs past the end of the file — check-council-record', validator: validatorPath('check-council-record.mjs'), expect: 'finding F1 cites package.json lines 1-99999 but the file has 63 lines' },
