...
- Verify the brief is approved or explicitly waived.
- Turn every active `R` and `RI` into ordered implementation phases.
...
- Produce a plan that Build can execute one phase at a time.
